# **CVCNN4PuDe:** A CloudA Novel Voronoi-based Convolutional Neural Network Framework for Pushing Person Detection in Crowd Videos
<p align='center'>
...
<li><a href="#models">Code for Trained CNN Models Evaluation</a>
...
<tr>
    <td align='center'> <img src='input.gif' /></td>
    <td align='center'> <img src='output.gif' /></td>
</tr>
</table>
...
## Running
 ...
 Note: If some libraries are required for running the framework, just use the following command to install it
 ```
